...
var City = function () {
  (this.province = []), (this.city = []), (this.a1 = []), (this.e1 = {});
  ...
  this.getCities = function (province) {
    ...
    for (let i = 0; i <= cities[province].length - 1; i++) {
      this.city.push(cities[province][i]);
    }
    return this.city;
  };
  ...
  this.showCities = function (province, element) {
    ...
    if (province.indexOf(".") !== -1 || province.indexOf("#") !== -1) {
      ...
      for (let i in this.getCities(province)) {
        str +=
          '<option value="' + this.city[i] + '">' + this.city[i] + "</option>";
      }
      elem = element;
    }
    this.city = [];
    ...
    document.querySelector(this.e1).onchange = function () {
      var Obj = new City();
